...
public interface NetworkEndpoints {
    ...
    String UPCOMING_MOVIES_BASE_URL = "movie/upcoming?" + API_KEY + "&page=";
    String MOVIES_POPULAR_BASE_URL = "movie/popular?" + API_KEY + "&page=";
    String MOVIE_GENRE_URL = "genre/movie/list?" + API_KEY;
    String MOVIE_SEARCH_BASE_URL = "search/movie?query=query_string&" + API_KEY + "&page=";
    String MOVIE_SIMILAR_CREDITS_VIDEOS_URL = "movie/movie_id?" + API_KEY + "&append_to_response=similar,credits,videos";
    String MOVIE_IMAGES = "movie/movie_id/images?" + API_KEY;


    //  URL'S PERTAINING TO TV SERIES
    String TV_GENRE_URL = "genre/tv/list?" + API_KEY;
    String TV_SERIES_ON_THE_AIR_BASE_URL = "tv/on_the_air?" + API_KEY + "&page=";
    String TV_SERIES_POPULAR_BASE_URL = "tv/popular?" + API_KEY + "&page=";
    String TV_SERIES_SEARCH_BASE_URL = "search/tv?query=query_string&" + API_KEY + "&page=";
    String TV_SERIES_SIMILAR_CREDITS_VIDEOS_URL = "tv/tv_id?" + API_KEY + "&append_to_response=similar,credits,videos";
    String TV_SERIES_IMAGES = "tv/tv_id/images?" + API_KEY;


    //  URL'S PERTAINING TO CELEBRITIES
    String CELEBRITY_POPULAR_BASE_URL = "person/popular?" + API_KEY + "&page=";
    String CELEBRITY_BIODATA_BASE_URL = "person/person_id?" + API_KEY + "&append_to_response=movie_credits,tv_credits";
    String CELEBRITY_SEARCH_BASE_URL = "search/person?query=query_string&" + API_KEY + "&page=";
    String CELEBRITY_IMAGES = "person/person_id/images?" + API_KEY;
